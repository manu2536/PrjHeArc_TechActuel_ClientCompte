package ch.hearc.ig.ta.prjergonomie.servlets;
...
import ch.hearc.ig.ta.prjergonomie.services.GamificationService;
import ch.hearc.ig.ta.prjergonomie.utilities.Level;
import ch.hearc.ig.ta.prjergonomie.services.ServicesImpl;
import ch.hearc.ig.ta.prjergonomie.utilities.AlertMessage;
import ch.hearc.ig.ta.prjergonomie.utilities.FakeData;
      ...
      case "doDeleteClient":
        ...
        if (request.getParameter("id") != null) {
          try {
            ...
            request.getSession().removeAttribute("SelectedClient");
            request.getSession().removeAttribute("searchedValue");
