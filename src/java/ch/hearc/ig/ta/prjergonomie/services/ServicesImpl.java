...
import ch.hearc.ig.ta.prjergonomie.business.Client;
import ch.hearc.ig.ta.prjergonomie.business.Compte;
import ch.hearc.ig.ta.prjergonomie.business.Virement;
import ch.hearc.ig.ta.prjergonomie.dao.ClientDao;
import ch.hearc.ig.ta.prjergonomie.dao.CompteDao;
import ch.hearc.ig.ta.prjergonomie.dbfactory.OracleConnections;
import ch.hearc.ig.ta.prjergonomie.exceptions.AccountDaoException;
import ch.hearc.ig.ta.prjergonomie.exceptions.CommitException;
import ch.hearc.ig.ta.prjergonomie.exceptions.ConnectionProblemException;
import ch.hearc.ig.ta.prjergonomie.exceptions.IDCompteException;
import ch.hearc.ig.ta.prjergonomie.exceptions.InsufficientFundException;
import ch.hearc.ig.ta.prjergonomie.exceptions.InvalidMontantException;
import ch.hearc.ig.ta.prjergonomie.exceptions.MetierException;
import ch.hearc.ig.ta.prjergonomie.exceptions.RollbackException;
import ch.hearc.ig.ta.prjergonomie.log.ApplicationLogger;
...
public class ServicesImpl {
  ...
  public Virement prepareVirementForList(Compte compteDebit, Compte compteCredit, float montant){
     ...
     virement.setNomClientCredit(clientCredit.getPrenom() + " " + clientCredit.getNom());
   ...
   * @param montant
   * @throws ch.hearc.ig.ta.prjergonomie.exceptions.MetierException
   */
